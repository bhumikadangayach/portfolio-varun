    ...
    <div className="bg-[#444444] text-left text-white font-sans w-full">
      ...
      <div className="px-20 py-32">
        ...
        <a href="https://calendly.com/imksonig/30min">
          <button className="bg-[#2A2A2B] text-white px-10 py-3 rounded-md hover:bg-gray-100 hover:text-black">
            Book a call
          </button>
        </a>
      </div>
      ...
      <div className="bg-[#2A2A2B] text-gray-400 px-20 py-6 items-center">
        <div className="flex flex-col justify-content-center md:flex-row ">
          {/* Left - Name */}
