    ...
    <div  className=" w-full bg-[#efefef]">
      ...
      <section className="bg-[#efefef] text-black px-20 md:px-16 py-16 font-manrope">
        <div className="max-w-6xl mx-auto">
          {/* Section 1 */}
          <h2 className="text-5xl md:text-5xl px-5 text-left  mb-6">
            My inspirations and interests
          </h2>
          <div className="md:flex md:gap-10 text-lg md:text-xl text-left px-5 text-gray-800 leading-relaxed mb-20">
