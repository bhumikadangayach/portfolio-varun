...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 bg-[#ffffffb3] backdrop-blur-md shadow-sm transition-transform duration-600 ${
      ...
      <div className="max-w-7xl mx-auto pl-12 pr-6 py-7 flex justify-between items-center">
        ...
        <div className="hidden md:block space-x-4 text-sm px-10 text-[#584391]">
          ...
          <a href="https://calendly.com/imksonig/30min">
            <button className="bg-white text-gray-900 border text-m px-6 py-2 rounded-xl hover:bg-gray-900 hover:text-white transition-all duration-300">
              Book a Meet
            </button>
          </a>
        </div>
